	...
	<body>
		...
		<div class = "padbak">
			...
			<img src = "../images/agent.png"  height = "180px" width = "180px" style = "position: absolute; left:25%; top: 10px;">
				...
				<input type = "image" src = "../images/answer.png" class = "cimg" id = "answer1" onclick = "showform()">
			...
			<form method = "get" action = "callPage.php" id = "getfrm">
				<input type = "phone" name = "callnumb" pattern = "[0-9]{10}" class = "dispnumb" id = "vatnum" >
				<input type = "submit" name = "numsub1" value = "Get Details"  id = "numsub2">
			</form>
		...
		<form name = "dialform" class = "dialformfir" id = "dialing" action = "#" method = "post">
			...
			Phone Number : </br>
			<input type = "phone" name = "telephone" placeholder = "0123456789" class ="formin" pattern = "[0-9]{10}" required <br/>
			...
			Inquiry Type:
			<select name = "arole" required class = "inqtype">
			...
			Solving Status : 
			<input type = "radio" name = "solve" required> Solved
			<input type = "radio" name = "solve" required> Unsolved<br/><br/>
			...
			Date : <input type = "data" class ="formin1">	
			Start Time : <input type = "time" class ="formin1">	
			End Time : <input type = "time" class ="formin1"><br/><br/>
			<center>
			<button type = "submit" id = "submbtn" value = "Submit" onclick = "hideform()" disabled><b>Submit</b></button><br/><br/><br/>
			</center>
			</div>
