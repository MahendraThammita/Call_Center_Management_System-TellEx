...
<html>
	...
	<?php
			...
			$check = $_GET['callnumb'];
			setcookie("number" , "$check" );
			
			$sql = "select Fname , Lname , NIC , Address , Province , Email
					from Customer
					where NIC = (select NIC
			...
			{
				header("location: call page2.php");
	...
	?>
		...
		<form name = "dialform" class = "dialform" id = "dialing" action = "SubmitCallDetails.php" method = "post">
			...
			Nic :<br/>
			<input type = "text" name = "NIC" placeholder = "012445678V" class ="formin" pattern = "[0-9]{9}+V" required value = <?php echo $NIC ?>></br>
			First name : <br/>
			<input type = "text" name = "First name" placeholder = "Enter the Name" id = "unmtchbtn" required value = <?php  echo$fname ?>><br/>
			Last name : </br>
			<input type = "text" name = "lastname" placeholder = "Last Name" class ="formin" value = <?php echo $lname?>><br/>
			Phone Number : </br>
			<input type = "phone" name = "telephone" placeholder = "0123456789" class ="formin" pattern = "[0-9]{10}" required value = <?php echo $check; ?>><br/>
			...
			<h2>Address</h2>
			Address Line 1 :<br/>
			<input type = "text" name = "address line 1"  class ="formin" value = <?php echo $address1 ?>><br/>
			...
			Province : <br/>
			<input type = "text" name = "province" class ="formin" value = <?php echo $province?>></br>
			...
			<div id = "custbtm">
			Email : 
			<input type = "email" name = "email" placeholder = "abc@gmail.com"  class ="formin"  value = <?php echo $email?>><br/>
			<br/>
			...
			Date : <input name = "date" type = "text" class ="formin1" value = "<?php echo $cdate ?>" >	
